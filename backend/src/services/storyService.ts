...
// IP Metadata interface for Flow
...
export const registerIpWithFlow = async (
    ipHash: string,
    metadata: string,
    isEncrypted: boolean,
    modredIpContractAddress: Address
  ...
  return {
            ...
            const checkNonceError = (err: any, depth: number = 0): boolean => {
                ...
                // Check for HTTP 410 errors related to pending blockTag (Flow RPC limitation)
...
export const mintLicenseOnFlow = async (
    tokenId: number,
