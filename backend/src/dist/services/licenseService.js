...
const mintLicense = async (licenseRequest) => {
    try {
        ...
        const hasExistingLicense = await (0, storyService_1.checkExistingLicenses)(licenseRequest.tokenId, licenseRequest.imiteContractAddress);
        ...
        const { txHash, blockNumber, explorerUrl } = await (0, storyService_1.mintLicenseOnFlow)(licenseRequest.tokenId, licenseRequest.royaltyPercentage, licenseRequest.duration, licenseRequest.commercialUse, licenseRequest.terms, licenseRequest.imiteContractAddress);
        const result = {
            success: true,
            txHash,
            blockNumber,
            explorerUrl,
            message: 'License minted successfully on Flow'
        };
        ...
        return {
            ...
            message: 'Failed to mint license on Flow'
        };
    }
};
