            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-[16px]">
                <Button
                  type="button"
                  onClick={() =>
                    handleInputChange({ paymentType: "Periodic" })
                  }
                  ...
                  <div className="space-y-2">
                    <div className="flex gap-4">
                      <Button
                        ...
                        className={`${
                          formData.periodicPayment?.interval === "Monthly"
                            ? "bg-[#F6E18B] text-black"
                      ...
                      <Button
                        ...
                        className={`${
                          formData.periodicPayment?.interval === "Quarterly"
                            ? "bg-[#F6E18B] text-black"
                            : "bg-[transparent] border border-[#8A8A8A] text-white hover:bg-[#F6E18B] hover:text-black"
                        }`}
                      >
                      ...
                      <Button
                        ...
                        className={`${
                          formData.periodicPayment?.interval === "Annually"
                            ? "bg-[#F6E18B] text-black"
                            : "bg-[transparent] border border-[#8A8A8A] text-white hover:bg-[#F6E18B] hover:text-black"
                        }`}
                      >
